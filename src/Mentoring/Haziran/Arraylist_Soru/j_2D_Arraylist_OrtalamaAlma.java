package Mentoring.Haziran.Arraylist_Soru;

import java.util.ArrayList;

public class j_2D_Arraylist_OrtalamaAlma {
...
*/
        ...
        System.out.println("matematik Ort = " + matOrt);

        int turOrt = dersOrtalamaBul(1, notlarArrList);
        System.out.println("turkçe Ort = " + turOrt);

        int kimOrt = dersOrtalamaBul(2, notlarArrList);
        System.out.println("kimya Ort = " + kimOrt);
